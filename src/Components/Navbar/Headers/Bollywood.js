...
const Bollywood = () => {
    ...
    const [BollyImg1Data, SetBollyImg1Data] = useState([]);
    const [BollyImg1Data2, SetBollyImg1Data2] = useState([]);
    ...
    useEffect(() => {
        ...
        fetch(apiUrl)
            ...
            .then((data) => {
                ...
                const BollyImg1Items = data.filter((item) => item.category === "BollyImg1");
                SetBollyImg1Data(BollyImg1Items);

                const BollyImg1Items2 = data.filter((item) => item.category === "BollyImg2");
                SetBollyImg1Data2(BollyImg1Items2);
            })
            .catch((error) => {
